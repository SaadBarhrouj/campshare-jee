...
public class ClientNotificationsServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    req.setAttribute("notifications", notificationService.getClientNotifications(userId));

    req.getRequestDispatcher("/jsp/notifications/notifications-client.jsp").forward(req, resp);
  }
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    resp.sendRedirect(req.getContextPath() + "/client/notifications");
  }
}