                        ...
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4">
                            <div>
                                ...
                                <div class="mt-2 flex items-center text-gray-600 dark:text-gray-300">
                                    ...
                                    <span><c:out value="${partner.city != null ? partner.city.name : ''}"/>, Maroc</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="w-12 text-right text-gray-500 dark:text-gray-400 text-sm">{{ $userP->fiveStarPercentagePartner(5) }}%</div>
                                    </div>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="w-12 text-right text-gray-500 dark:text-gray-400 text-sm">{{ $userP->fiveStarPercentagePartner(4) }}%</div>
                                    </div>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="w-12 text-right text-gray-500 dark:text-gray-400 text-sm">{{ $userP->fiveStarPercentagePartner(3) }}%</div>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="w-12 text-right text-gray-500 dark:text-gray-400 text-sm">{{ $userP->fiveStarPercentagePartner(2) }}%</div>
                                    </div>
                                    <div class="flex items-center mb-2">
                                        ...
                                        <div class="w-12 text-right text-gray-500 dark:text-gray-400 text-sm">{{ $userP->fiveStarPercentagePartner(1) }}%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                                <div class="flex justify-between items-start">
                                    <div class="flex">
                                        ...
                                        <div>
                                            <a href="#" class="font-bold text-gray-900 dark:text-white hover:text-forest dark:hover:text-meadow">${review.reviewer != null ? review.reviewer.username : ''}</a>
