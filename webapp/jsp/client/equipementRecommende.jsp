                ...
                <c:choose>
                    <c:when test="${not empty similarListings}">
                        <c:forEach var="res" items="${similarListings}">
                            <c:if test="${res.listing != null && res.listing.item != null}">
                                <div class="equipment-card bg-white dark:bg-gray-800 rounded-xl shadow-sm overflow-hidden flex flex-col h-full">
                                    ...
                                    <a href="${pageContext.request.contextPath}/listing?id=${res.listing.id}" class="block relative h-48">
                                        <c:choose>
                                            <c:when test="${not empty res.listing.item.images && not empty res.listing.item.images[0]}">
                                                <img src="${pageContext.request.contextPath}/uploads/${res.listing.item.images[0].url}" 
                                        ...
                                        <div class="absolute bottom-4 left-4 right-4">
                                            ...
                                            <c:if test="${res.listing.item.category != null}">
                                    ...
                                    <div class="p-4 flex flex-col flex-grow">
                                        ...
                                        <div class="flex justify-between items-start mb-3">
                                            ...
                                            <div class="flex items-center text-sm">
                                                <c:choose>
                                                    <c:when test="${res.partner != null && res.partner.reviewCount > 0 && res.partner.avgRating > 0}">
                                        ...
                                        <c:if test="${res.listing.startDate != null && res.listing.endDate != null}">
                                        ...
                                        <c:if test="${res.listing.city != null}">
