...
<body class="font-sans antialiased text-gray-800 dark:text-gray-200 bg-gray-100 dark:bg-gray-900 min-h-screen flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-8 transition-all duration-300 fade-in">
        <!-- Logo -->
        ...
        <form id="login-form" class="space-y-6">
            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    <a href="forgot-password.html" class="text-sm font-medium text-forest dark:text-meadow hover:text-opacity-80 dark:hover:text-opacity-80 transition duration-150">
                        Mot de passe oublié ?
                    </a>
                </div>
                <div class="relative">
        ...
        <div class="mt-8 flex flex-col sm:flex-row justify-center items-center space-y-3 sm:space-y-0 sm:space-x-4">
            <a href="${pageContext.request.contextPath}/register" class="footer-link text-forest dark:text-meadow hover:text-opacity-90 dark:hover:text-opacity-90">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('login-form').addEventListener('submit', function(e) {
                ...
                if (!passwordInput.value) {
                    ...
                    passwordInput.classList.remove('border-gray-300', 'dark:border-gray-600');
                    valid = false;
                } else {
                ...
                setTimeout(function() {
                    ...
                    alert('Ce formulaire est une démo. En production, il authentifierait l\'utilisateur via un serveur sécurisé.');
                }, 1500);
            });
        });
    </script>
