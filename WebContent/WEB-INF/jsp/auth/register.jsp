...
<html lang="fr" class="scroll-smooth">
    ...
    >
        ...
        >
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700 dark:text-blue-300">
                            Pour garantir la sécurité de notre communauté et
                            faciliter vos transactions, nous demandons une
                            vérification d'identité lors de la création de votre
                            compte. Ces informations sont sécurisées et ne
                            seront utilisées que pour valider votre identité
            ...
            <!-- Error messages -->
            <div id="server-errors" class="hidden mb-6 p-4 bg-red-50 dark:bg-red-900/30 rounded-lg">
                <div class="flex">
            ...
            >
                ...
                <section id="step-1" class="step-section">
                    ...
                    >
                        <i
                            class="fas fa-user-circle mr-2 text-forest dark:text-meadow"
                        ></i>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            >
                                8 caractères minimum, incluant lettres, chiffres
                ...
                <section id="step-2" class="step-section hidden">
                    ...
                    >
                        <i
                            class="fas fa-id-card mr-2 text-forest dark:text-meadow"
                        ></i>
                ...
                <section id="step-3" class="step-section hidden">
                    ...
                    >
                        ...
                        >
                            ...
                            <ul class="list-disc pl-5 space-y-1">
                                <li>
                                    ...
                                    conditions de location et d'utilisation du
                                    matériel.
                                </li>
                                <li>
                                    CampShare peut suspendre un compte en cas
                                    d'abus.
                                </li>
                                <li>
                        ...
                        >
                            ...
                            <ul class="list-disc pl-5 space-y-1">
                                <li>
                                    ...
                                    nécessaires à la gestion de vos locations.
                                </li>
                                <li>
                                    Vos données ne sont jamais revendues à des
                                    tiers.
                                </li>
                                <li>
                                    Vous pouvez demander la suppression de vos
                        ...
                        >
                            ...
                            <p class="mb-2">
                                En utilisant CampShare, vous acceptez les
                            ...
                            <ul class="list-disc pl-5 space-y-1">
                                ...
                                <li>
                                    Les retards de retour peuvent entraîner des
                                    frais supplémentaires.
                                </li>
                                <li>
                                    Les dommages ou pertes doivent être signalés
                                    immédiatement.
                                </li>
                                <li>
                                    CampShare se réserve le droit de suspendre
                                    tout compte non conforme aux règles.
                                </li>
                                <li>
                                    Le service est fourni "tel quel" sans
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 text-sm">
                                ...
                                >
                                    En cochant cette case, vous pourrez proposer
                                    vos équipements à la location.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <input id="is_subscribed"
                                name="is_subscribed" type="checkbox" value="1"
                                class="h-4 w-4 text-forest focus:ring-forest
            ...
            document.addEventListener("DOMContentLoaded", function () {
                ...
                function validateStep(step) {
                    ...
                    if (step === 1) {
                        ...
                        requiredFields.forEach((field) => {
                            const value = document
                                ...
                                ?.value.trim();
                            if (!value)
                                showError(field.id, `${field.name} est requis`);
                        });
                    ...
                    if (!valid) {
                        ...
                        const errorList =
                            document.getElementById("client-error-list");
